...
<template>
	<div class="dark:bg-slate-900">
		...
		<section>
			<div class="flex flex-col gap-12 m-6 lg:mx-60 lg:my-8 min-h-screen dark:text-white">
				<div class="flex items-center border-2 dark:border-slate-800 bg-black/5 rounded-xl">
					<svg
						width="24"
						height="24"
						viewBox="0 0 24 24"
				...
				<div class="grid grid-cols-1 lg:grid-cols-3 auto-rows-auto gap-6">
						<div
							...
							:key="i"
							class="flex h-64 rounded-xl hover:scale-90 transition-transform cursor-pointer dark:bg-black/40"
		...
		<transition name="fade">
				<div class="fixed right-0 top-0 z-50 flex h-screen w-screen lg:w-96 overflow-y-scroll rounded-xl dark:text-white bg-white dark:bg-slate-800" v-if="proj" :class="{ 'fade-enter-active': proj }">
